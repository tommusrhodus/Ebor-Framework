...
function ebor_styled_map_shortcode( $atts, $content = null ) {
	...
	$output = '<div class="map-container '. esc_attr($custom_css_class) .'" data-maps-api-key="'. $api_key .'" data-address="'. $address .'" data-marker-title="'. esc_attr(get_bloginfo('title')) .'" data-map-style="'. esc_attr($style) .'"></div>';
