...
add_shortcode( 'kwoon_map_block', 'ebor_map_block_shortcode' );
	...
	vc_map( 
		array(
			...
			"params" => array(
				...
				array(
					"type" => "attach_image",
					"heading" => __("Map Marker Image", 'kwoon'),
					"param_name" => "image"
				),
			)
		) 
