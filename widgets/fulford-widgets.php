	...
	class ebor_Instagram_Widget extends WP_Widget {
		...
		public function __construct(){
			parent::__construct(
				...
				__('Fulford: Instagram Widget', 'fulford'), // Name
				array( 'description' => esc_html__( 'Add a simple Instagram feed widget', 'fulford' ), ) // Args
			);
		}
		...
		?>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title:', 'fulford' ); ?></label> 
				<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id( 'username' ); ?>"><?php esc_html_e( 'Username:', 'fulford' ); ?></label> 
	...
	class ebor_Twitter_Widget extends WP_Widget {
		...
		public function __construct(){
			parent::__construct(
				...
				__('Fulford: Twitter Widget', 'fulford'), // Name
				array( 'description' => esc_html__( 'Add a simple Twitter feed widget', 'fulford' ), ) // Args
			);
		}
	...
	class ebor_ebor_popular_Widget extends WP_Widget {
		...
		function ebor_ebor_popular_Widget(){
			parent::__construct(
				...
				array( 'description' => esc_html__( 'Add a simple popular posts widget', 'fulford' ), ) // Args
			);
		}
