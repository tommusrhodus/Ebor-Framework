	...
	class ebor_Instagram_Widget extends WP_Widget {
		...
		public function __construct(){
			parent::__construct(
				...
				__('Gallery: Instagram Widget', 'gallery'), // Name
				array( 'description' => esc_html__( 'Add a simple Instagram feed widget', 'gallery' ), ) // Args
			);
		}
		...
		?>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title:', 'gallery' ); ?></label> 
				<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id( 'username' ); ?>"><?php esc_html_e( 'Username:', 'gallery' ); ?></label> 
	...
	class ebor_Twitter_Widget extends WP_Widget {
		...
		public function __construct(){
			parent::__construct(
				...
				__('Gallery: Twitter Widget', 'gallery'), // Name
				array( 'description' => esc_html__( 'Add a simple Twitter feed widget', 'gallery' ), ) // Args
			);
		}
	...
	class ebor_ebor_popular_Widget extends WP_Widget {
		...
		public function __construct(){
			parent::__construct(
				...
				__('Gallery: Popular Posts', 'gallery'), // Name
				array( 'description' => esc_html__( 'Add a simple popular posts widget', 'gallery' ), ) // Args
			);
		}
