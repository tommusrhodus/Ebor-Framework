...
if(!class_exists('AQ_Block')) {
	class AQ_Block {
	 	...
	 	function block($instance) {
	 		extract($instance);
	 		echo __('function AQ_Block::block should not be accessed directly. Output generated by the ', 'ebor-framework') . strtoupper($id_base). ' Class';
	 	}
	 	...
	 	function form($instance) {
	 		echo '<p class="no-options-block">' . __('There are no options for this block.', 'ebor-framework') . '</p>';
	 		return 'noform';
	 	}
	 				...
	 				'<dl class="block-bar">',
	 					'<dt class="block-handle">',
	 						...
	 						'<span class="block-controls">',
	 							'<a class="block-edit" id="edit-'.$number.'" title="'. __('Edit Block', 'ebor-framework') .'" href="#block-settings-'.$number.'">'. __('Edit Block', 'ebor-framework') .'</a>',
	 						'</span>',
	 					'</dt>',
	 				'</dl>',
